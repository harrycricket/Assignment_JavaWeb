...
public class AuthenFilter implements Filter {
    ...
    public AuthenFilter() {
        ...
        US_RESOURCE.add("checkOut.jsp");

        AD_RESOURCE = new ArrayList<>();
        AD_RESOURCE.add("admin.jsp");
        AD_RESOURCE.add("createProduct.html");
        AD_RESOURCE.add("createProduct.jsp");
        AD_RESOURCE.add("product.jsp");
        ...
        NON_AUTHEN_RESOURCE.add("LoginWithGoogle");
        NON_AUTHEN_RESOURCE.add("userGoogle.jsp");
    }
