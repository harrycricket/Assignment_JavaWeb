...
public class UserDAO {
    ...
    private static final String UPDATE_TOKEN = "UPDATE tblUsers SET token = ? WHERE userID = ?";
    ...
    public static void updateToken(String userID, String token) throws SQLException {
        Connection conn = null;
        PreparedStatement ptm = null;
        try {
            conn = DBUtils.getConnection();
            if (conn != null) {
                ptm = conn.prepareStatement(UPDATE_TOKEN);
